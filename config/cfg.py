...
class BaseConfig(object):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--save_folder', default='/data2/chengyi/Multi_Raters/result/save_model/checkpoint_catar/', help='Path to save checkpoint models')
        self.parser.add_argument('--save_log', default='/data2/chengyi/Multi_Raters/result/save_log/logs_catar/',help='Path to save checkpoint models')
        ...
        self.parser.add_argument('--data_name', default='pretrain')
        ...
        self.parser.add_argument('--fold', default=0, type=int, help='use k fold validation')
        ...
        self.parser.add_argument('--val_freq', default=-1, type=int,help='do validation every # iterations, =train_epoch_size-1')
    ...
    def initialize(self, fixed=None, show=False):
        ...
        if self.args.debug:
            self.args.save_log = '/data2/chengyi/Multi_Raters/result/DEBUG_logs/'
            self.args.save_folder = '/data2/chengyi/Multi_Raters/result/DEBUG_models/'
